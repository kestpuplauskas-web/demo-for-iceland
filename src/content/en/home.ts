export const home = {
  ...
  ratings: {
    eyebrow: "Booking.com ratings",
    items: [
      {
        score: "9.0",
        label: "Standard apartments",
        note: "Booking.com guest rating. Cleanliness and location are most often praised.",
      },
      {
        score: "9.3",
        label: "Apartments with a terrace",
        note: "Booking.com guest rating. The terrace and the calm are most often praised.",
      },
    ],
  },
  bookingBand: {
  ...
  notFound: {
    ...
    text: "This address doesn't work or the page has been moved. Return home or browse the apartments.",
    home: "Home",
    stays: "Apartments",
  },
};
